...
function CreateQuest() {
  ...
  useEffect(() => {
    if (issueUrl) {
      const selectedIssue = issues.find((issue) => issue.html_url === issueUrl);
      if (selectedIssue) {
        ...
        <Form {...form}>
          ...
          >
            <ScrollArea className="h-[480px] w-[750px] rounded-md border px-4 text-black">
              <div className="my-4">
                <FormLabel className="block mb-2">Source de la tâche</FormLabel>
                <Tabs
                  defaultValue="github"
                  value={activeTab}
                ...
                >
                  ...
                  <TabsContent value="github" className="mt-4 space-y-4">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Dépôt GitHub</FormLabel>
                  ...
                  <TabsContent value="jira" className="mt-4 space-y-4">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Projet Jira</FormLabel>
                          <div className="flex items-center">
                            <Select
                              onValueChange={field.onChange}
                              value={field.value}
                    ...
                    {jiraProjectSelected && (
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem className="transition-all duration-300">
                            <FormLabel>Ticket Jira</FormLabel>
                            <div className="flex items-center">
                              <Select
                                onValueChange={field.onChange}
                                value={field.value}
                        ...
                        <p className="text-sm text-muted-foreground mt-1">
                          {"html_url" in selectedIssue ? (
                            ...
                            <a
                              ...
                              className="flex items-center gap-1 text-blue-600 hover:underline"
                            >
                              Voir sur Jira <ExternalLink className="h-3 w-3" />
                            </a>
                          )}
                        </p>
                      </div>
                      <Badge>
                        {"html_url" in selectedIssue ? "GitHub" : "Jira"}
                      </Badge>
                    </div>
                  </CardContent>
                </Card>
